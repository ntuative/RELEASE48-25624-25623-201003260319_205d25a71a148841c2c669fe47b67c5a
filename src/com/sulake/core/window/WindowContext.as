package com.sulake.core.window
{
   ...
   public class WindowContext implements IWindowContext, IDisposable, IUpdateReceiver
   {
      ...
      public static var var_1596:IMouseCursor;
      
      public static const const_1463:int = 2;
      
      private static var var_979:Factory;
      ...
      protected var var_2258:IWindowFactory;
      
      private var _disposed:Boolean = false;
      
      private var var_666:WindowController;
      
      private var var_747:Date;
      
      protected var var_2256:IWindowParser;
      
      protected var var_930:Error;
      
      protected var var_2257:IInternalWindowServices;
      ...
      public function WindowContext(param1:String, param2:IWindowRenderer, param3:IWindowFactory, param4:ICoreLocalizationManager, param5:DisplayObjectContainer, param6:Rectangle, param7:IWindowContextStateListener)
      {
         ...
         var_324 = param5;
         var_2257 = new InternalWindowServices(this,param5);
         var_2258 = param3;
         var_2256 = new WindowParser(this);
         var_747 = new Date();
         if(var_979 == null)
         {
            var_979 = new Factory();
         ...
         var_324.addChild(var_86.getDisplayObject());
      ...
      public function destroy(param1:IWindow) : Boolean
      {
         ...
         if(param1.state != WindowState.const_435)
         {
            param1.destroy();
         }
         return true;
      ...
      {
         var _loc12_:Class = var_979.getWindowClassByType(param3);
         if(_loc12_ == null)
         {
            handleError(WindowContext.const_1381,new Error("Failed to solve implementation for window \"" + param1 + "\"!"));
            return null;
         }
         if(param8 == null)
         {
      ...
      public function dispose() : void
      {
         ...
         var_324.removeChild(IGraphicContextHost(var_86).getGraphicContext(true) as DisplayObject);
         var_86.destroy();
         var_86 = null;
         var_1102.destroy();
         var_1102 = null;
      ...
      private function stageResizedHandler(param1:Event) : void
      {
         if(var_86 != null && true)
         {
            if(var_324 is Stage)
            {
               var_86.width = Stage(var_324).stageWidth;
               var_86.height = Stage(var_324).stageHeight;
            }
            else
            {
               var_86.width = var_324.width;
               var_86.height = var_324.height;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         while(true)
         {
            ...
            if(_loc2_.stageX != var_561.x || _loc2_.stageY != var_561.y)
            {
               ...
               _loc5_ = new Array();
               var_86.groupChildrenUnderPoint(var_561,_loc5_);
            }
               ...
               if(_loc4_ != null && _loc4_.visible)
               {
                  ...
                  else if(_loc2_.type == MouseEvent.MOUSE_UP || _loc2_.type == MouseEvent.CLICK)
                  {
                     if(var_93 && true)
                     {
                        if(var_357 != null)
                        {
                           var_357.mouseEventReceived(_loc2_.type,var_93);
                        }
                     }
                  }
                  if(_loc2_.altKey)
      ...
      public function getMouseCursor() : IMouseCursor
      {
         if(var_1596 == null)
         {
            var_1596 = new MouseCursorControl(var_324);
         }
         return var_1596;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_360))
         {
