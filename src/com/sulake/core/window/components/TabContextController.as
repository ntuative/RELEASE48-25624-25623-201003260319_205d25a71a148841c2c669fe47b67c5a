package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1090:String = "selector";
       
      
      private var var_1257:Boolean = false;
      
      protected var var_935:ITabSelectorWindow;
      
      private var var_873:Boolean = false;
      
      protected var var_1601:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1601 == null)
         {
            var_1601 = findChildByTag(TabContextController.const_1091) as IWindowContainer;
         }
         return var_1601;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_935 == null)
         {
            var_935 = findChildByTag(TabContextController.const_1090) as ITabSelectorWindow;
            if(var_935 != null)
            {
               var_935.procedure = selectorEventProc;
            }
         }
         return var_935;
      }
      ...
      {
         return !!var_873 ? selector.iterator : null;
      }
