package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1358:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_927:ICatalogViewer;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         var_1386 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1386) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_925);
      }
      ...
      private function createWidgets() : void
      {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1358;
            _loc2_.init();
         }
         var_1358.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1358.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_925);
      }
