package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_749:uint = 11;
      ...
      private var var_772:LagWarningLogger = null;
      
      private var var_773:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_772 = new LagWarningLogger();
         var_1134 = new Array(const_749);
         var _loc4_:int = 0;
         while(_loc4_ < const_749)
         {
            var_1134[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1212,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_607,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_894,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1264);
               break;
            case HabboCommunicationEvent.const_609:
               trackLoginStep(HabboLoginTrackingStep.const_1231,String(_communication.port));
               break;
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_305:
      ...
      {
         var_145 = IHabboConfigurationManager(param2);
         if(var_145)
         {
            Component(var_145).events.addEventListener(HabboConfigurationEvent.const_169,onConfigurationLoaded);
            if(var_213 != null)
            {
               var_213.configuration = var_145;
            }
            if(var_214 != null)
            {
               var_214.configuration = var_145;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_272.events.addEventListener(AdEvent.const_392,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_894,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_607,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_609,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_595,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_59,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_418,onHotelViewEvent);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_773)
            {
               var_773.release(new IIDHabboWindowManager());
               var_773 = null;
            }
            if(var_272)
            {
            ...
            if(var_163)
            {
               if(true)
               {
                  ...
                  Component(var_163).events.removeEventListener(HabboFriendListTrackingEvent.const_305,onFriendlistTrackingEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_145)
         {
            if(var_772 != null)
            {
               var_772.configure(var_145);
            }
            Component(var_145).events.removeEventListener(HabboConfigurationEvent.const_169,onConfigurationLoaded);
         }
      }
      ...
      {
         var_773 = IHabboWindowManager(param2);
         if(var_773)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++var_1402;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1402);
         }
      ...
      {
         if(var_145 != null && Boolean(var_145.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_163).events.addEventListener(HabboFriendListTrackingEvent.const_305,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_145)
            {
               if(var_145.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_145.getKey("client.fatal.error.url");
