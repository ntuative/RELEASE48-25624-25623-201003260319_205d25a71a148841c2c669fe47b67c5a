package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1108:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1506:XML;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1506 == null)
         {
            ...
            var_1506 = _loc4_.content as XML;
         }
         if(var_1507 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1506) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_48 = navigator.catalog.windowManager.buildFromXML(var_1507) as IItemListWindow;
         if(var_48 == null)
         {
