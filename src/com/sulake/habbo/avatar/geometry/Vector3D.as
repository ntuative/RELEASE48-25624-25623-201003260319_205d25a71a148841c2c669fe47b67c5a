package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.y = var_81 * param1.x - var_80 * param1.z;
         _loc2_.z = var_80 * param1.y - _y * param1.x;
         return _loc2_;
      }
      ...
      {
         return Math.sqrt(var_80 * var_80 + _y * _y + var_81 * var_81);
      }
      ...
      {
         return var_80 * param1.x + _y * param1.y + var_81 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + var_80 + "," + _y + "," + var_81 + "," + var_1047 + ")";
      }
