package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_793:IRoomSession;
      ...
      private const const_1630:int = 500;
      ...
      private var var_968:IncomingMessages;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            var_18.events.removeEventListener(RoomSessionEvent.const_91,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionEvent.const_99,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_474,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_99:
               var_793 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_474:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_44.getValue(InventoryCategory.const_568));
      }
      ...
      {
         var_153.clubPeriods = param1;
         var_153.clubDays = param2;
         var_153.clubHasEverBeenMember = param3;
      ...
      {
         return PetsModel(var_44.getValue(InventoryCategory.const_139));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1630);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_44.getValue(InventoryCategory.const_287));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_792.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_792.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_44.getValue(InventorySubCategory.const_274));
      }
      ...
      {
         return var_153.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_44.getValue(InventoryCategory.const_464) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_968 = new IncomingMessages(this);
      ...
      {
         return var_153.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_153.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_44.getValue(InventoryCategory.const_235));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_91,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionEvent.const_99,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_474,roomSessionEventHandler);
         ...
         var_44.add(InventoryCategory.const_464,_loc3_);
         ...
         var_44.add(InventoryCategory.const_139,_loc10_);
