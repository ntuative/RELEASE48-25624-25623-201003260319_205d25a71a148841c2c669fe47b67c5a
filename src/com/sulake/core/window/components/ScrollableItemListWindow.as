   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_351)
         {
            ...
            if(var_351)
            {
               var_351.addEventListener(WindowEvent.const_276,scrollBarEventProc);
               var_351.addEventListener(WindowEvent.const_198,scrollBarEventProc);
            }
         }
         return var_351;
      }
      ...
      override public function dispose() : void
      {
         if(var_351)
         {
            var_351.removeEventListener(WindowEvent.const_276,scrollBarEventProc);
            var_351.removeEventListener(WindowEvent.const_198,scrollBarEventProc);
            var_351 = null;
         }
         if(var_875)
         {
