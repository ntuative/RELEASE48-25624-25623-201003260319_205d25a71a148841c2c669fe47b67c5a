package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1440:int = 5;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_2243 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2242 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_753 = new Timer(1000,1);
         var_753.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
      ...
      private function createWindow() : void
      {
         ...
         _window.addEventListener(WindowEvent.const_462,onWindowMoved);
         var_1361 = true;
         var_140 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2244 = _loc2_.width + const_490 + _loc6_.width + const_1139;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1138,_loc8_.width) + const_490);
            _loc8_.x = _loc12_;
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_532);
