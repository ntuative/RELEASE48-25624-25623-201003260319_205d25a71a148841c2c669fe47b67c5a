package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return var_1149.indexOf(param1) > -1;
      }
      ...
      {
         return var_657.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         {
            _loc2_ = var_657.indexOf(var_1150[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_291[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_780 + _loc3_);
                  _loc3_ += var_1151;
               }
            }
            _loc4_++;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = var_657.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = getIconById(param1);
            if(_loc3_ != null)
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_291[var_657.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_1744.elements("menu");
         var _loc5_:int = 0;
