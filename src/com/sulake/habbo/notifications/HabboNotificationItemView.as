package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      private static const const_341:Number = 50;
      
      public static const const_721:int = 70;
      
      private static const const_761:int = 2;
      
      public static const const_408:int = 4;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar)
      {
         ...
         if(_loc7_ != null)
         {
            var_1179 = 0 - _loc7_.rectangle.bottom;
         }
         else
         {
            var_1179 = 15;
         }
         var_1450 = _window.height;
         var_572 = 4;
         var_400 = 0;
         var_31 = const_342;
         var_196 = param5;
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _window.height = 0;
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + var_1179;
         if(_window.height < var_1450)
         {
            _window.height = var_1450;
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(var_31)
         {
            ...
            case const_428:
               var_807 += param1;
               _loc2_ = Number(var_807) / Number(var_401["time_fade_in"]);
               if(var_807 > int(var_401["time_fade_in"]))
               {
                  startDisplay();
               }
               adjustBlend(_loc2_);
            ...
            case const_761:
               var_985 += param1;
               if(var_985 > int(var_401["time_display"]) && !var_1178)
               {
                  startFadeOut();
               }
               break;
            case const_760:
               var_808 += param1;
               _loc3_ = 1 - Number(var_808) / Number(var_401["time_fade_out"]);
               adjustBlend(_loc3_);
               if(var_808 > int(var_401["time_fade_in"]))
               {
                  startIdling();
               }
         }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = var_196.orientation == "TOP" ? int(const_341) : 0;
         var _loc4_:int = var_196.orientation == "BOTTOM" ? int(_loc2_.height - const_341) : int(_loc2_.height);
         var _loc5_:int = var_196.orientation == "LEFT" ? int(const_341) : 0;
         var _loc6_:int = var_196.orientation == "RIGHT" ? int(_loc2_.width - const_341) : int(_loc2_.width);
         if(false)
         {
            if(false)
            {
               _window.x = _loc5_ + const_408;
            }
            else
            {
               _window.x = _loc6_ - 0 - const_408;
            }
         }
         else if(false)
         {
         ...
         if(false)
         {
            if(false)
            {
               _window.y = _loc3_ + var_572;
            }
            else
            {
               _window.y = _loc4_ - 0 - var_572;
            }
         }
         else if(false)
         {
