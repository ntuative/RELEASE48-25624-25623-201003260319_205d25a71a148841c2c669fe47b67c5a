package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1989.clone());
      ...
      {
         var_1989 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
         ...
         var_48 = IItemListWindow(var_51.findChildByName("visits_list"));
