package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var include:ITextWindow;
      ...
      private var var_791:IDropMenuWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1730.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_656.setText(param1.eventDescription);
         var_789.setText(getTagFromEvent(param1,1));
         var_790.setText(getTagFromEvent(param1,2));
         var_1148.visible = false;
         var_1147.visible = true;
         var_1146.visible = true;
         var_1424.visible = false;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1423 = IWindowContainer(find("event_type_disabled_cont"));
            var_1730 = ITextWindow(find("event_type_disabled_text"));
            var_1424 = ITextWindow(find("create_caption"));
            include = ITextWindow(find("edit_caption"));
            var_1148 = IButtonWindow(find("create_button"));
            var_1147 = IButtonWindow(find("edit_button"));
            var_1731 = IButtonWindow(find("cancel_button"));
            var_1146 = IButtonWindow(find("end_button"));
            var_791 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1148,onCreateButtonClick);
            Util.setProcDirectly(var_1147,onEditButtonClick);
            ...
            var_789 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_790 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
