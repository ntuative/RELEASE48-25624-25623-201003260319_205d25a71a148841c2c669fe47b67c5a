package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1417:String = "messageinput";
      ...
      private var var_1190:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1190 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_862 = IWindowContainer(var_13.content.findChildByName("main_content"));
         var_245 = IWindowContainer(var_13.content.findChildByName("footer"));
         var_1190.prepare(var_862);
         var_13.procedure = onWindow;
         var_13.content.setParamFlag(HabboWindowParam.const_965,false);
         var_13.content.setParamFlag(HabboWindowParam.const_1213,true);
         var_13.header.setParamFlag(HabboWindowParam.const_571,false);
         var_13.header.setParamFlag(HabboWindowParam.const_895,true);
         var_13.content.setParamFlag(HabboWindowParam.const_571,false);
         var_13.content.setParamFlag(HabboWindowParam.const_895,true);
         var_13.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1189 = ITextWindow(var_13.findChildByName("info_text"));
         var_1189.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_13.scaler.setParamFlag(HabboWindowParam.const_571,false);
         var_13.scaler.setParamFlag(HabboWindowParam.const_965,false);
         var_13.scaler.x = 0 - var_13.scaler.width;
         var_13.scaler.y = 0 - var_13.scaler.height;
         var_1455 = var_13.height;
         var_1456 = var_13.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc4_:int = var_1456 == -1 ? 0 : int(0 - var_1456);
