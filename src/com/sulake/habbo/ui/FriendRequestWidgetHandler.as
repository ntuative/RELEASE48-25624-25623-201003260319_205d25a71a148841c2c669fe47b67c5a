package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_710);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_699);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_553);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case FriendRequestEvent.const_238:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_710:
            ...
            case RoomWidgetFriendRequestMessage.const_699:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_553:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(FriendRequestEvent.const_238);
         return _loc1_;
      }
