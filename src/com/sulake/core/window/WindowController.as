package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1487:Point = new Point();
      ...
      protected var var_629:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_400 = _loc13_.blend;
            var_535 = _loc13_.treshold;
            if(var_628 != _loc13_.background)
            {
               background = _loc13_.background;
            }
            if(var_536 != _loc13_.color)
            {
               color = _loc13_.color;
            }
         }
         ...
         if(param7 != null)
         {
            ...
            if(var_15)
            {
               var_14.invalidate(this,var_7,WindowRedrawFlag.const_72);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_113,WindowParam.const_144);
         var _loc2_:* = !testParamFlag(WindowParam.const_112,WindowParam.const_137);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_7.clone();
            if(_loc1_)
      ...
      {
         var_628 = param1;
         var_536 = !!var_628 ? uint(var_536 | var_1371) : uint(var_536 & 16777215);
      ...
      {
         var_535 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1928 + "]";
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_15)
         {
            var_15 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_588,var_7);
            var_15.visible = var_328;
         }
         return var_15;
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         var_14.invalidate(this,var_7,WindowRedrawFlag.const_835);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_321,this,param1));
         return param1;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_535);
      }
      
      public function set color(param1:uint) : void
      {
         var_1371 = param1 & 4278190080;
         var_536 = !!var_628 ? uint(param1) : uint(param1 & 16777215);
         var_14.invalidate(this,var_7,WindowRedrawFlag.const_72);
      }
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_165:
                  ...
                  if(param1 == this)
                  {
                     ...
                     else if(testParamFlag(WindowParam.const_175,WindowParam.const_137))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_8 != null)
                     {
                        _loc8_ = uint(_param);
                        _param &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_357))
                        {
                           var_8.width += 0 - 0;
                        }
                        ...
                        _param = _loc8_;
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_261,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_375:
                  var_14.invalidate(this,var_7.union(var_54),WindowRedrawFlag.const_388);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_861,this,null));
                     if(var_8 != null)
                     {
               ...
               case WindowNotifyEvent.const_336:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_604,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_196,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_437:
                  var_14.invalidate(this,var_7,WindowRedrawFlag.const_825);
                  break;
               case WindowNotifyEvent.const_354:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_481:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_14.invalidate(this,var_7,WindowRedrawFlag.const_388);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_196:
                  ...
                  break;
               case WindowNotifyEvent.const_352:
                  var_8.getRegionProperties(null,var_302);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_321:
      ...
      {
         return var_629 != null ? var_629 : (var_8 != null ? var_8.procedure : nullEventProc);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_535);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_627,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_709;
         update(this,_loc1_);
         return true;
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_927,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_678,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1269,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_62,true);
         _loc1_.type = WindowNotifyEvent.const_1292;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_160 && var_535 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_7.width && param1.y <= var_7.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1487,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1487,param3,param1)) : false;
            }
         }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_14.invalidate(this,param1,WindowRedrawFlag.const_72);
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1361,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_62,false);
         _loc1_.type = WindowNotifyEvent.const_1279;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_8 != param1)
         {
            ...
            if(var_8 != null)
            {
               var_302 = var_8.rectangle.clone();
               var_54.x = var_7.x;
               var_54.y = var_7.y;
               var_54.width = var_7.width;
               var_54.height = var_7.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_413,this,var_8));
            }
            else
            {
               var_302.x = 0;
               ...
               var_302.width = 0;
               var_302.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_827,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_78,_param,var_14,var_7,null,var_629,properties,var_627.concat(),_id) as WindowController;
         ...
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_323;
         _loc2_.background = var_628;
      ...
      {
         if(var_31 == WindowState.const_435)
         {
            return true;
         }
         var_31 = WindowState.const_435;
