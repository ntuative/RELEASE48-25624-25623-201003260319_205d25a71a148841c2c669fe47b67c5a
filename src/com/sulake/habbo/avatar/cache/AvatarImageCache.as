package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1415:int = 60000;
      ...
      public function getAnimationDataInFrame(param1:String, param2:int) : AnimationLayerData
      {
         ...
         return var_67.getBodyPartData(_loc4_.definition.state + "." + _loc4_.actionParameter,param2,param1);
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc17_ = var_67.getAnimation(_loc5_.definition.state + "." + _loc5_.actionParameter);
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_742)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_386)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         var _loc16_:AvatarImageDirectionCache = _loc15_.method_10(_loc4_);
         if(_loc16_ == null)
         {
            debugInfo("[CacheMiss (actionCache.getDirectionCache)] [AvatarImageCache.getImageContainer] direction: " + [param1,_loc4_]);
            _loc10_ = var_67.getParts(param1,(var_823 as AvatarImage).getFigure(),_loc6_,var_1182,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_67.getCanvas(var_184,var_1182);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1177[param1])
            {
            ...
            else
            {
               ...
               {
                  _loc34_ = var_67.renderManager.paletteManager.getPalette(_loc7_.paletteMapId);
               ...
               if((_loc32_ == AvatarAction.const_856 || _loc32_ == AvatarAction.const_508) && (_loc6_ == AvatarBodyPartType.const_291 || _loc6_ == AvatarBodyPartType.const_1284 || _loc6_ == AvatarBodyPartType.const_1347) && _loc7_.color != null)
               {
      ...
      public function setAction(param1:IActiveActionData) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Array = var_67.getActiveBodyPartIds(param1);
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = var_67.getBodyPartsUnordered(param1);
