package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_1389:String = null;
      ...
      protected var var_2263:Number = NaN;
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1389 != null && var_1389.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2266,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_1969 != param1 || var_1971 != param2)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_1970 != param1 || var_1968 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2266 = _loc3_.getNumber(RoomObjectVariableEnum.const_228);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_225));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1389 = _loc3_.getString(RoomObjectVariableEnum.const_322);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_288 != _loc3_.getUpdateID() || param1 != var_209 || param2 != var_2263)
         {
