package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_999:String = "_EXCLUDE";
      
      public static const const_1588:String = "_TEMP";
      ...
      protected var var_1377:Map;
      
      protected var var_14:IWindowContext;
      
      protected var var_1376:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1107,var_1106);
         var_937 = new Dictionary();
         var_1376 = new Dictionary();
         ParamCodeTable.fillTables(var_937,var_1376);
         var_1377 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1376)
            {
               delete var_1376[_loc1_];
            }
            var_1377.dispose();
            var_1377 = null;
            var_14 = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_999) == -1)
                  {
