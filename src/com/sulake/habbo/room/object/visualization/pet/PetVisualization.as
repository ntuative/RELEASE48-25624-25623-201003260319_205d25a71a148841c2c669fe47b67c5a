package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_831:PetVisualizationData = null;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc10_:* = 0;
         var _loc12_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_922);
         if(_loc12_ > 0)
         {
            _loc17_ = getTimer() - _loc12_;
            if(_loc17_ < AvatarAction.const_849)
            {
               _loc10_ = uint(int(Math.sin(Number(_loc17_) / 0 * 0) * 255));
               _loc11_ = _loc4_.getNumber(RoomObjectVariableEnum.const_1027);
               var_519 = const_1118;
            }
         }
         var _loc13_:Boolean = false;
         var _loc14_:String = _loc4_.getString(RoomObjectVariableEnum.const_248);
         switch(_loc14_)
         {
         ...
         var _loc15_:Boolean = var_288 != _loc3_.getUpdateID() || var_209 != param1.scale || var_161 != _loc4_.getUpdateID();
         var _loc16_:Boolean = _isAnimating || var_519 > 0 || _loc13_;
         if(_loc15_ || _loc16_)
         {
            increaseUpdateId();
            _loc18_ = getTimer();
            ...
            if(var_402 != _loc7_)
            {
               for each(_loc36_ in var_408.getKeys())
               {
                  var_408.remove(_loc36_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            ...
            _loc20_ = _loc4_.getNumber(RoomObjectVariableEnum.const_284);
            if(isNaN(_loc20_))
            {
               _loc20_ = _loc19_;
            }
            ...
            _loc21_ = _loc4_.getString(RoomObjectVariableEnum.const_248);
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_597);
            ...
            {
               _loc38_ = _loc4_.getNumber(RoomObjectVariableEnum.const_376);
               _loc39_ = 3;
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_438) > 0;
            if(_loc25_)
            {
            ...
            {
               _loc29_ = null;
               _loc29_ = var_831.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc29_ != null)
               {
            ...
            var_832.push(getTimer() - _loc18_);
            if(false)
            {
               _loc56_ = 0;
               _loc57_ = "[";
               for each(_loc58_ in var_832)
               {
                  _loc56_ += _loc58_;
                  _loc57_ += "," + _loc58_;
               }
      ...
      {
         var_831 = param1 as PetVisualizationData;
         createSprites(4);
         return true;
      }
