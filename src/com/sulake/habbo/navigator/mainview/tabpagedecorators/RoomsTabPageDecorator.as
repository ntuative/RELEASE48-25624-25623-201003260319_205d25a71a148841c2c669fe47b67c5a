package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_236,Tabs.const_282);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_236,Tabs.const_648);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_236,Tabs.const_282,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_475 == null)
         {
            var_475 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_475.procedure = onChangeFilter;
