   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_146,onUserTags);
            ...
            if(false)
            {
               ...
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetCommandsUpdateEvent.const_134,onPetCommands);
            }
         }
         _container = param1;
         if(param1 == null)
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_146,onUserTags);
         ...
         if(false)
         {
            ...
            _container.roomSessionManager.events.addEventListener(RoomSessionPetCommandsUpdateEvent.const_134,onPetCommands);
         }
      }
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1020);
            ...
            case RoomObjectCategoryEnum.const_35:
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_843)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_672);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_213)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_673);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1166;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_952;
                  }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_673);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_394);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_618);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_401)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_541:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_865,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_665:
               ...
               break;
            case RoomWidgetUserActionMessage.const_394:
            ...
            case RoomWidgetFurniActionMessage.const_269:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_618:
