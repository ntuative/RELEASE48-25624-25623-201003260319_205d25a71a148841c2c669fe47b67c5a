package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_786:AvatarEditorHandler;
      
      private var var_386:Map;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_887:ISessionDataManager;
      ...
      private const const_1051:int = 2;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_655.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_159)
         {
            ...
            var_464["null"] = new FigureData(this);
            var_464["null"] = new FigureData(this);
            _loc1_ = var_464["null"];
            _loc2_ = var_464["null"];
            ...
            var_87 = new Map();
            var_386 = new Map();
            var_87.add(AvatarEditorFigureCategory.const_850,new BodyModel(this));
            ...
            var_87.add(AvatarEditorFigureCategory.const_1309,new LegsModel(this));
            var_87.add(AvatarEditorFigureCategory.const_1298,new HotLooksModel(this));
            var_386.add(AvatarEditorSideCategory.WARDROBE,new WardrobeModel(this));
            var_386.add(AvatarEditorSideCategory.const_369,new ClubPromoModel(this));
            var_159 = true;
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_887 = param2 as ISessionDataManager;
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_967 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1420;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_967 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1051)
                  {
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1394)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_967 >= _loc6_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_386.getValue(AvatarEditorSideCategory.WARDROBE);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_786 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_655.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_386.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorFigureCategory.const_850);
         return true;
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_655 = var_553.getFigureData(AvatarType.const_78);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_553 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_967 = param3;
         var _loc4_:FigureData = var_464[param2];
         if(_loc4_ == null)
         {
            return;
         }
