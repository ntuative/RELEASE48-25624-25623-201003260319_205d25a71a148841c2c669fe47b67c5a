package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1070 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1070 != null)
         {
            var_1070.addEventListener(WindowKeyboardEvent.const_631,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1070.text));
      }
   }
}
