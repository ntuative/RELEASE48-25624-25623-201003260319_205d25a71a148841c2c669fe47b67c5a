package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public static const const_513:String = "Rectangle";
      
      public static const const_57:String = "Boolean";
      
      public static const const_577:String = "Number";
      
      public static const const_61:String = "int";
      
      public static const STRING:String = "String";
      
      public static const const_628:String = "Point";
      
      public static const const_966:String = "Array";
      
      public static const const_960:String = "uint";
      
      public static const const_446:String = "hex";
      
      public static const const_854:String = "Map";
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean)
      {
         ...
         _type = param3;
         var_1877 = param4;
         var_2296 = param3 == const_854 || param3 == const_966 || param3 == const_628 || param3 == const_513;
      }
      ...
      public function toXMLString() : String
      {
         ...
         switch(_type)
         {
            case const_854:
               ...
               _loc1_ = "<var key=\"" + var_580 + "\">\r<value>\r<" + _type + ">\r";
               _loc2_ = 0;
            ...
            case const_513:
               ...
               break;
            case const_446:
               _loc1_ = "<var key=\"" + var_580 + "\" value=\"" + "0x" + uint(var_167).toString(16) + "\" type=\"" + _type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + var_580 + "\" value=\"" + var_167 + "\" type=\"" + _type + "\" />";
         }
         return _loc1_;
      }
