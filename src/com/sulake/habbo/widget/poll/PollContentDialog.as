package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function method_8(param1:IWindowContainer, param2:Array) : void
      {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_735[var_1066] as Dictionary;
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1066;
         if(var_1066 < var_735.length)
         {
            _loc1_ = var_735[var_1066] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               switch(_loc3_)
               {
                  case 1:
                     ...
                     break;
                  case 2:
                     method_8(_loc4_,_loc1_["selections"]);
                     break;
                  case 3:
