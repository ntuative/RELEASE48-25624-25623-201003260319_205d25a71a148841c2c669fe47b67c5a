package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1192:int = 10000;
      ...
      private var var_723:IEncryption;
      
      private var var_722:int;
      
      private var var_358:ByteArray;
      ...
      private var var_606:IProtocol;
      
      private var var_891:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_290 = param2;
         var_358 = new ByteArray();
         var_891 = new MessageClassManager();
         var_76 = new Socket();
         var_359 = new Timer(const_1192,1);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_891.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         var _loc5_:ByteArray = var_606.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_357)
         {
         ...
         if(var_723 != null)
         {
            _loc3_ = var_723.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_358.writeByte(var_76.readUnsignedByte());
         }
      }
      ...
      {
         var_891.registerMessages(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_606.getMessages(var_358,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            if(var_357)
            {
               var_357.messageReceived(String(_loc5_),_loc6_.toString());
            }
            _loc7_ = var_891.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
         ...
         else if(_loc2_ > 0)
         {
            ...
            _loc18_.writeBytes(var_358,_loc2_);
            var_358 = _loc18_;
         }
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_723 + "\n");
      }
   }
}
