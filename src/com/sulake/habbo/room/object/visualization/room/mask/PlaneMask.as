package com.sulake.habbo.room.object.visualization.room.mask
{
   ...
   public class PlaneMask
   {
      ...
      protected function getMaskVisualization(param1:int) : PlaneMaskVisualization
      {
         ...
         {
            var_724 = var_423.getValue(String(_sizes[_loc2_])) as PlaneMaskVisualization;
         }
         else
         {
            var_724 = null;
      ...
      public function createMaskVisualization(param1:int) : PlaneMaskVisualization
      {
         ...
         var_423.add(String(param1),_loc2_);
         _sizes.push(param1);
         _sizes.sort();
         return _loc2_;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_423 != null)
         {
            ...
            {
               _loc1_ = var_423.getWithIndex(_loc2_) as PlaneMaskVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
