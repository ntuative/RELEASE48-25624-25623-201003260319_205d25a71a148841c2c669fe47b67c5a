package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_816:String = "AssetLibraryReady";
      
      public static const const_1223:String = "AssetLibraryUnloaded";
      
      public static const const_433:String = "AssetLibraryLoaded";
      
      public static const const_1283:String = "AssetLibraryLoadError";
      ...
      private var var_471:Boolean = true;
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_669)
         {
            delete var_669[_loc1_];
         }
         if(var_16 != null)
         {
            var_16.dispose();
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(var_471)
         {
            AssetLibrary.fetchLibraryContents(this,var_472,var_337);
         }
         var_294 = true;
         dispatchEvent(new Event(AssetLibrary.const_433));
         dispatchEvent(new Event(AssetLibrary.const_816));
         if(var_471)
         {
            var_16.dispose();
            var_16 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_886,assetLoadEventHandler);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_982.splice(var_982.indexOf(this),1);
            --var_562;
            var_395 = null;
            var_669 = null;
            _loadedAssets = null;
      ...
      {
         var _loc2_:Class = var_669[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
