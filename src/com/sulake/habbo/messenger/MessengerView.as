package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_827:ConversationsTabView;
      
      private var _disposed:Boolean = false;
      
      private var var_128:HabboMessenger;
      
      private var var_1205:ConversationView;
      ...
      private function onMessageInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_690.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.var_1205.afterResize();
         this.var_827.refresh();
      }
      ...
      private function sendMsg() : void
      {
         ...
         var_690.text = "";
         var_128.conversations.addMessageAndUpdateView(new Message(Message.const_666,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      ...
      public function openMessenger() : void
      {
         ...
         if(var_13 == null)
         {
            prepareContent();
            refresh(true);
            var_128.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.MESSENGER,var_13));
         }
         else
         {
            refresh(true);
      ...
      {
         return this.var_827 == null ? 7 : int(this.var_827.getTabCount());
      }
      ...
      {
         var_13 = IFrameWindow(var_128.getXmlWindow("main_window"));
         ...
         var_827 = new ConversationsTabView(var_128,var_13);
         var_827.refresh();
         var_690 = ITextFieldWindow(var_13.findChildByName("message_input"));
         var_690.addEventListener(WindowKeyboardEvent.const_150,onMessageInput);
         var_1205 = new ConversationView(var_128,var_13);
