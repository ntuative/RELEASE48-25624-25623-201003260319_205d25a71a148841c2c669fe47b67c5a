package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_886:RoomCreateViewCtrl;
      
      private var var_2016:RoomThumbnailRenderer;
      
      private var var_196:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_603:RoomInfoViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_274 = new MainViewCtrl(this);
         var_603 = new RoomInfoViewCtrl(this);
         var_886 = new RoomCreateViewCtrl(this);
         var_2016 = new RoomThumbnailRenderer(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_274.startSearch(Tabs.const_207,Tabs.const_295,param1);
         var_274.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && var_196 != null)
         {
            var_196.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_887)
         {
            var_887.release(new IIDSessionDataManager());
            var_887 = null;
         }
         if(_catalog)
         {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_145.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_196 != null)
         {
            var_196.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_196.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_274.startSearch(Tabs.const_263,Tabs.const_202);
         var_388.getTab(Tabs.const_263).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_274.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
