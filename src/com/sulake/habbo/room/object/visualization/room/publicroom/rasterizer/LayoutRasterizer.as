package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1042:LayoutRasterizerData = null;
      ...
      private var var_907:IGraphicAssetCollection;
      
      private var var_1333:XMLList;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1044 = param1;
         var _loc3_:LayoutRasterizerData = var_40.getValue(var_721);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1282 = RoomObjectVariableEnum.const_858;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1282 = RoomObjectVariableEnum.const_899;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1044 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1044 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         if(param2 == var_2063 && param3 == var_2062)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_1044 + _adBgIndex);
            _loc5_ = param1.getSprite(var_1044 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1282);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_422;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_721)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1042 = var_40.getValue(var_721);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_40.getValue(var_721);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_1042.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = var_907.getAsset(_loc8_.@asset);
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_352.indexOf(_loc10_) >= 0 && var_516)
            {
               param1 = var_352.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_907.getAsset(var_517[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
