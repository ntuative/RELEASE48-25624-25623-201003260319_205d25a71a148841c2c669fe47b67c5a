package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_520:String = "bg";
       
      
      private var var_2223:IContainerButtonWindow;
      
      private var var_2224:IContainerButtonWindow;
      
      private var var_2222:IContainerButtonWindow;
      
      private var var_2221:IContainerButtonWindow;
      ...
      {
         var_2224 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_2222 = initButton("open_homepage",onHomeButtonClick,param1);
         var_2223 = initButton("room_invite",onInviteButtonClick,param1);
         var_2221 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_520);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_2224,isEnableMinimailButton(_loc1_));
         setEnabled(var_2222,isEnableHomeButton(_loc1_));
         setEnabled(var_2223,isEnableInviteButton(_loc1_));
         setEnabled(var_2221,isEnableRemoveButton(_loc1_));
      }
      ...
      private function onHomeButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:Friend = _friendList.categories.method_11();
         if(_loc3_ == null)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_520);
