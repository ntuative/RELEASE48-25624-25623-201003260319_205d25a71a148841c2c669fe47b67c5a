package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_819:IAvatarRenderManager;
      ...
      private var var_818:FriendRequests;
      
      private var var_1799:int;
      
      var var_87:FriendCategories;
      
      private var var_1865:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_820:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1865 = new FriendListLookAndFeel();
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_818.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_818.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_388.findTab(FriendListTab.const_85).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_818 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_87.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_87.addCategory(new FriendCategory(FriendCategory.const_821,getText("friendlist.friends")));
         var_87.addCategory(new FriendCategory(FriendCategory.const_466,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_479)
         {
            var_479 = new Timer(120000);
            var_479.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_479.start();
         }
         getBuddyRequests();
         registerListeners();
         var_196.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_479.stop();
            var_479.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_479 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_819)
         {
            var_819.release(new IIDAvatarRenderManager());
            var_819 = null;
         }
         if(var_820)
         {
            var_820.release(new IIDHabboNotifications());
            var_820 = null;
         }
         if(var_196)
         {
      ...
      {
         var _loc1_:String = var_145.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_305));
            }
            else
            {
               switch(_loc1_.id)
      ...
      {
         var_196 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_818.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_196.events.dispatchEvent(_loc1_);
      }
      ...
      {
         var _loc2_:FriendListTab = var_388.findTab(FriendListTab.const_85);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_819.createAvatarImage(param1,AvatarScaleType.const_95);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_818.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_388.findTab(FriendListTab.const_85);
      ...
      {
         var_820 = param2 as IHabboNotifications;
      ...
      {
         return var_145.getKey(param1,param1,param2);
      }
