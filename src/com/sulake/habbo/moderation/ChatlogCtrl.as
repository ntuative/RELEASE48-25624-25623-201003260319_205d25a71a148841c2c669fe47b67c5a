package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1522:IMessageComposer;
      ...
      {
         var_802 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_803 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         var_48 = IItemListWindow(var_51.findChildByName("chatline_list"));
         var_51.procedure = onWindow;
         var _loc1_:IWindow = var_51.findChildByTag("close");
         _loc1_.procedure = onClose;
         _main.connection.send(var_1522);
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_803.clone());
         _loc4_.color = var_1176[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
