package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_621[var_1085] as Array;
      ...
      {
         var _loc2_:Offer = var_621[var_1085][var_2227];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_476 || _loc1_.pricingModel == Offer.const_361)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_81 || _loc3_.productType == ProductTypeEnum.const_77)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1086.indexOf(_loc5_) == -1)
                        {
                           var_1086.push(_loc5_);
                           var_621.push(new Array());
                        }
                        _loc6_ = var_1086.indexOf(_loc5_);
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_621)
         {
            if(var_2227 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2227] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1085 = var_936.getGridItemIndex(param1.view);
