package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      override public function dispose() : void
      {
         if(var_758)
         {
            context.removeLocalizationListener(var_323,this);
         }
         if(var_65 != null)
         {
            var_65.dispose();
      ...
      public function set text(param1:String) : void
      {
         ...
         var_323 = param1;
         if(var_323.charAt(0) == "$" && var_323.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_323.slice(2,var_323.indexOf("}")),this);
            var_758 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_960,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_577,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_577,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_57,true));
         _loc1_.push(new PropertyStruct("margin_left",var_65.left,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_top",var_65.top,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_right",var_65.right,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_65.bottom,PropertyStruct.const_61,true));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_577,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
