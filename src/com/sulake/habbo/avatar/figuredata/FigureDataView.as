package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_window != null)
         {
            var_615 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_615 && var_1067)
         {
            var_615.bitmap = new BitmapData(var_615.width,var_615.height,true,16777215);
            var_615.bitmap.copyPixels(var_1067,var_1067.rect,new Point(0,0 - 0 - 8));
            var_615.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
