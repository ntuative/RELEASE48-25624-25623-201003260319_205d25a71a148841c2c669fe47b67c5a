package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1419:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_989,var_990,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_989,var_679,var_990,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1194 = param1.chatType;
         var_989 = param1.userId;
         var_679 = param1.userName;
         var_990 = param1.userCategory;
         _message = param1.text;
         var_1195 = param1.userX;
         var_190 = param1.userImage;
         var_991 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(var_80,_y,width,_height);
      ...
      public function renderView() : void
      {
         ...
         if(var_190 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_404 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_991 != 0)
            {
               _loc30_ = uint(var_991 >> 16 & 255);
               _loc31_ = uint(var_991 >> 8 & 255);
               _loc32_ = uint(var_991 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1194 == RoomWidgetChatUpdateEvent.const_268)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_679);
            }
            else if(var_1194 == RoomWidgetChatUpdateEvent.const_254)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_679);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_344 + _loc20_.textWidth + const_490;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_989,var_990,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_989,var_990,_roomId,_roomCategory,param1);
      }
