package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_757 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_757.procedure = onSearchInput;
         var_757.addEventListener(WindowKeyboardEvent.const_150,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_48.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_290,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_757.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
