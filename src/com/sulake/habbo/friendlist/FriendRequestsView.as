package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private var var_1510:IContainerButtonWindow;
      
      private var _friendList:HabboFriendList;
      
      private var var_1509:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_306 && _loc4_.state != FriendRequest.const_293)
            {
      ...
      {
         var_1510 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1509 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1509.procedure = onDismissAllButtonClick;
         var_1510.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_306 && _loc4_.state != FriendRequest.const_293)
            {
               _loc4_.state = FriendRequest.const_293;
               refreshRequestEntry(_loc4_);
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_238,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_293)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1510,_loc1_);
         setEnabled(var_1509,_loc1_);
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_293;
         var _loc3_:DeclineBuddyMessageComposer = new DeclineBuddyMessageComposer();
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_238,param1));
         }
      }
   }
}
