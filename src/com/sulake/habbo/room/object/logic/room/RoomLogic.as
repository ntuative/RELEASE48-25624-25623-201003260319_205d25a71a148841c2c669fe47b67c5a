package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1555:int = 1500;
      
      private var var_1556:int = 255;
      
      private var var_1554:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               ...
               case RoomObjectRoomUpdateMessage.const_693:
                  ...
                  break;
               case RoomObjectRoomUpdateMessage.const_654:
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_351:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_232)
                  {
                     _loc8_ = "null";
                  }
                  var_391.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_658:
                  _loc7_ = var_391.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_391.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_1025,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_949,int(_loc5_.bgOnly));
            var_1310 = _color;
            var_1556 = var_1159;
            var_1060 = _loc11_;
            var_1554 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_833,param1.toString(),true);
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1252,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1300,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1389,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_151 || _loc13_ == RoomPlaneData.const_245)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_904)
         {
            ...
            {
               _loc7_ = var_1310 >> 16 & 255;
               _loc8_ = var_1310 >> 8 & 255;
               _loc9_ = var_1310 & 255;
               _loc10_ = var_1060 >> 16 & 255;
               _loc11_ = var_1060 >> 8 & 255;
               _loc12_ = var_1060 & 255;
               _loc13_ = (_loc2_ - var_904) / var_1555;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1556 + (var_1554 - var_1556) * _loc13_;
               _color = _loc3_;
               var_1159 = _loc4_;
            }
