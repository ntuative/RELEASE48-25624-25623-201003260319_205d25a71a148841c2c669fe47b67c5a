package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_2018:UserRegistry;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_129:TutorialUI;
      
      private var var_701:IHabboLocalizationManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_56:HelpUI;
      
      private var var_702:IHabboConfigurationManager;
      
      private var var_196:IHabboToolbar;
      
      private var var_600:HotelMergeUI;
      
      private var var_290:IHabboCommunicationManager;
      
      private var var_863:FaqIndex;
      
      private var var_1868:String = "";
      
      private var var_968:IncomingMessages;
      
      private var var_1260:CallForHelpData;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1260 = new CallForHelpData();
         var_2018 = new UserRegistry();
         super(param1,param2,param3);
         _assetLibrary = param3;
         var_863 = new FaqIndex();
      ...
      override public function dispose() : void
      {
         ...
         if(var_701)
         {
            var_701.release(new IIDHabboLocalizationManager());
            var_701 = null;
         }
         if(var_290)
         {
         ...
         if(var_702)
         {
            var_702.release(new IIDHabboConfigurationManager());
            var_702 = null;
         }
         if(_windowManager)
         {
      ...
      public function initHotelMergeUI() : void
      {
         if(!var_600)
         {
            var_600 = new HotelMergeUI(this);
         }
         var_600.startNameChange();
      }
      ...
      private function createHelpUI() : Boolean
      {
         ...
         {
            var_56 = new HelpUI(this,_assetLibrary,_windowManager,var_701,var_196);
         }
         return var_56 != null;
      }
      ...
      {
         var_1260.reportedUserId = param1;
         var_1260.reportedUserName = param2;
         var_56.showUI(HabboHelpViewEnum.const_314);
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_196 != null)
         {
            var_196.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.HELP));
         }
      }
      ...
      {
         var_701 = IHabboLocalizationManager(param2);
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_968 = new IncomingMessages(this,var_290);
      ...
      {
         var_196 = IHabboToolbar(param2);
         queueInterface(new IIDHabboLocalizationManager(),onLocalizationManagerReady);
      }
      
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_702 = IHabboConfigurationManager(param2);
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return var_702.getKey(param1,param2,param3);
      }
   }
}
