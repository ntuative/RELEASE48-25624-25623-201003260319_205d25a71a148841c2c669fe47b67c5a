      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_1024);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_912));
            ...
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_887));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_294);
               break;
            case "hc":
               ...
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_692);
               break;
            case "news":
               if(false && false)
               {
