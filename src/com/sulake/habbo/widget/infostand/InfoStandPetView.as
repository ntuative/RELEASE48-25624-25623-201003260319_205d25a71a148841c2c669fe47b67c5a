package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1647:String = "energy";
      
      private var var_1145:Map;
      
      private const const_1642:String = "nutrition";
      
      private var var_59:IItemListWindow;
      
      private const const_1645:uint = 3355443;
      
      private var var_235:IBorderWindow;
      
      private const const_1646:int = 158;
      
      private const const_1649:int = 16;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_235 != null)
         {
            var_101 = var_235.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_101 == null || var_235 == null || var_59 == null)
         {
            return;
         }
         ...
         var_235.height = NaN;
         _window.width = Math.max(var_235.width,var_59.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1145.getValue(var_647) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1647,param1.energy,param1.energyMax);
         updateStateElement(const_1642,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_647 = param1.id;
         var_1145.remove(param1.id);
         var_1145.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_394,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1646,const_1649,false);
         ...
         _loc5_.fillRect(_loc6_,const_1645);
