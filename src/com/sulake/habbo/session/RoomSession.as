package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1053:UserDataManager;
      ...
      {
         if(var_31 == RoomSessionEvent.const_298 && _connection != null)
         {
            var_31 = RoomSessionEvent.const_91;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1053 as IUserDataManager;
      }
