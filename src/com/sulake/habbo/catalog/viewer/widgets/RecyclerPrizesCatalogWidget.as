package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_927:PrizeViewer;
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            createLevelItem(var_754[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_927 = new PrizeViewer();
         var_754 = recycler.getPrizeTable();
         if(var_754 == null)
         {
            return;
         }
         ...
         populateItemGrid();
         if(false && var_754[0].prizes.length > 0)
         {
            select(var_754[0].prizes[0] as IGridItem);
         }
      }
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_927.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
