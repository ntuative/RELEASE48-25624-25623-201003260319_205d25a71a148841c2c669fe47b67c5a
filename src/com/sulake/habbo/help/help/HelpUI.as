package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2210:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","25624-25623-201003260245");
         var_196 = param5;
         var_103 = new Map();
         var_103.add(HabboHelpViewEnum.const_1369,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_141,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_353,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_234,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_219,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_684,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_314,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_720,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_223,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_103.add(HabboHelpViewEnum.const_973,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_503,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1567 = 0 - _loc3_.width;
         var_1566 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_280 == HabboHelpViewEnum.const_141 || false)
         {
            return;
         }
         if(var_438 == null)
      ...
      {
         return var_103.getValue(var_280);
      }
      ...
      {
         var_2209 = param1;
         var _loc2_:IHelpViewController = var_103.getValue(HabboHelpViewEnum.const_141) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_223:
               showUI(HabboHelpViewEnum.const_223);
               break;
            case CallForHelpResultEnum.const_908:
               showUI(HabboHelpViewEnum.const_973);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_280 == HabboHelpViewEnum.const_141)
         {
            return;
         }
         if(true)
         {
            ...
            var_617.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_617[1],var_617[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_617[0],var_617[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1566;
         _window.width = _loc1_.width + var_1567;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_196 != null)
            {
               var_196.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_554));
      }
