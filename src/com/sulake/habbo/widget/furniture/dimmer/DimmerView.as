package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_56,HabboWindowStyle.const_40,0 | 0,new Rectangle(const_1035,const_1036,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(var_345 != null)
         {
            var_345.setValue(var_1023);
         }
         var_403 = colors.indexOf(_loc2_.color);
         if(var_502 != null)
         {
            var_502.setSelectedColorIndex(var_403);
         }
