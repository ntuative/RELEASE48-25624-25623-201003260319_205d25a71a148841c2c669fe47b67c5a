package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_22.tellUI(HabboHelpViewEnum.const_219,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_22.tellUI(HabboHelpViewEnum.const_234,_loc6_);
      }
      ...
      {
         var_22.showUI(HabboHelpViewEnum.const_314);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_22.showUI(HabboHelpViewEnum.const_353);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_22.showUI(HabboHelpViewEnum.const_684);
         var_22.tellUI(HabboHelpViewEnum.const_684,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_378)
            {
         ...
         var_22.tellUI(HabboHelpViewEnum.const_503);
      }
