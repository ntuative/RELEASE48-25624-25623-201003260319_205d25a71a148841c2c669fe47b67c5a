package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_103:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_662,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_524];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_524:
      ...
      {
         return [RoomSessionDoorbellEvent.const_103,RoomSessionDoorbellEvent.const_130,RoomSessionDoorbellEvent.const_52];
      }
