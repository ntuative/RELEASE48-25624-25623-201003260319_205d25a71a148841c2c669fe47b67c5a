package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1432:int = 0;
      
      private var var_402:String;
      
      private var var_632:int = 0;
      
      private const const_1640:int = 1;
      ...
      private const const_1639:int = 2;
      
      private var var_831:AvatarVisualizationData = null;
      ...
      {
         var_831 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_408.getValue(_loc5_) as IAvatarImage;
         ...
         var _loc14_:Number = _loc8_ - var_1300;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_311);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_288 != _loc3_.getUpdateID() || var_209 != param1.scale || var_161 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_519 > 0;
         if(_loc20_ || _loc21_)
         {
            increaseUpdateId();
            --var_519;
            ...
            if(var_402 != _loc7_)
            {
               for each(_loc49_ in var_408.getKeys())
               {
                  var_408.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_831.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_408.remove(_loc5_);
               var_408.add(_loc5_,_loc6_);
               var_402 = _loc7_;
            }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_284);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_248) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_248);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_597);
            ...
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_376);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_292,AvatarAction.const_1168[_loc29_]);
               }
            }
            ...
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_798);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_985);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_904,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_672);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_739);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_873,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_979);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_1026,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_355);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_438) > 0;
            if(_loc35_ || _loc13_)
            {
            ...
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_951);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_537,_loc36_);
            }
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_959))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_831.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_832.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_832)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_408 != null)
         {
            _loc1_ = var_408.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_408.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
