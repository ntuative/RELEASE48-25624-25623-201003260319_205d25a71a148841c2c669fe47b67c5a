package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_487 = new Map();
         var_487.add(FurniModel.const_42,new FurniGridView(_model,FurniModel.const_42,_windowManager,_assetLibrary,_roomEngine));
         var_487.add(FurniModel.const_43,new FurniGridView(_model,FurniModel.const_43,_windowManager,_assetLibrary,_roomEngine));
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_487.getValue(var_488);
         if(_loc4_ != null)
         {
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = _model.getGroupItemInIndex(_loc3_,var_488);
