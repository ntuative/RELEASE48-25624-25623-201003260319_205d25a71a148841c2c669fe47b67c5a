package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_945 != null)
         {
            var_945.removeEventListener(WindowKeyboardEvent.const_150,windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         if(var_945 != null)
         {
            var_945.addEventListener(WindowKeyboardEvent.const_150,windowKeyEventProcessor);
         }
      }
