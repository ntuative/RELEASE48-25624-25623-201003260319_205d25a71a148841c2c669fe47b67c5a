package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1052:String = AvatarSetType.const_37;
      
      private static const const_1054:String = "Default";
      
      private static const const_1053:int = 125;
      ...
      private var var_466:IAvatarDataContainer;
      ...
      private var var_67:AvatarStructure;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         {
            _loc6_ = var_402.getPartSetId("pbd");
            solvePetAvatarTypeAndRace(_loc6_);
            _avatarSubType = var_970;
         }
         var_126 = new AvatarImageCache(var_67,this,_assets,var_184);
         setDirection(const_1052,const_1055);
         var_185 = new Array();
         resetActions();
      }
      ...
      private function solvePetAvatarTypeAndRace(param1:int) : void
      {
         ...
         var_970 = 0;
         var_1156 = 0;
         var _loc2_:ISetType = var_67.figureData.getSetType("pbd");
         if(_loc2_ != null)
         {
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(var_748 == AvatarType.PET && param1 == AvatarSetType.const_47)
         {
            ...
            _loc3_ = var_67.renderManager.petDataManager.getPetData(_avatarSubType);
            if(_loc3_ != null)
            {
         ...
         if(var_67.isMainAvatarSet(param1))
         {
            var_90 = param2;
         }
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_67.sortActions(var_185);
         if(_loc1_ == null)
         {
         ...
         {
            var_555 = var_67.getCanvasOffsets(_loc1_,var_184,var_90);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            {
               _isAnimating = true;
               _loc3_ = var_67.getAnimation(_loc2_.definition.state + "." + _loc2_.actionParameter);
               if(_loc3_ != null)
               {
                  var_174 = var_174.concat(_loc3_.spriteData);
                  if(_loc3_.hasDirectionData())
                  {
                     var_1157 = _loc3_.directionData.offset;
                  }
                  if(_loc3_.hasAvatarData())
                  {
                     var_466 = _loc3_.avatarData;
                  }
               }
            }
            if(_loc2_.actionType == AvatarAction.const_508)
            {
               _isAnimating = true;
            }
      ...
      {
         return var_67.getPartColor(var_402,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_67.getCanvas(var_184,var_165.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_67.getBodyParts(param1,var_165.definition,var_90);
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(var_748 == AvatarType.PET)
               {
                  ...
                  _loc17_ = var_67.getParts(_loc9_,var_402,_loc15_,"pet",_loc14_.getDirection(),[]);
                  _loc18_ = 32;
                  ...
                  if(_loc17_.length > 0)
                  {
                     ...
                     _loc23_ = var_67.getPartActionOffset(getSubType(),var_184,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_67.getCanvas(var_184,var_165.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_67.getBodyParts(param1,var_165.definition,var_90);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(var_748 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_67.getParts(_loc7_,var_402,_loc12_,"pet",_loc11_.getDirection(),[]);
                  ...
                  if(_loc14_.length > 0)
                  {
                     ...
                     _loc21_ = var_67.getPartActionOffset(getSubType(),var_184,_loc7_,_loc13_,_loc18_,_loc19_);
                     if(_loc21_ != null)
                     {
         ...
         if(var_466 != null)
         {
            if(false)
            {
               ...
               _image.paletteMap(_image,_image.rect,new Point(0,0),var_466.reds,[],[]);
            }
            else
            {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_466 = null;
         var_1157 = 0;
         var_67.removeDynamicItems();
         var_165 = new ActiveActionData(AvatarAction.const_903);
         var_165.definition = var_67.getActionDefinition(const_1054);
      ...
      {
         return var_67.getBodyPartData(param1.animation.id,var_467,param1.id);
      }
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         switch(param1)
         {
            case AvatarAction.const_646:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1142:
                     if(var_748 == AvatarType.const_78)
                     {
                        if(var_90 == 0)
                        {
            ...
            case AvatarAction.const_1026:
               _loc4_ = var_67.getActionDefinitionWithState(param1);
               if(_loc4_ != null)
               {
