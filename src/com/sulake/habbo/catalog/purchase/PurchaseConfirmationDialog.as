package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1438:uint = 4.294967295E9;
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_889;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_889,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1439) : uint(const_1438);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_602,var_77,var_1046);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_889);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_604[var_202]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_605[_ribbonIndex]);
         _catalog.purchaseProductAsGift(var_602,var_77,var_1046,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1496 = _loc1_.stuffTypes;
            var_604 = _loc1_.boxTypes;
            var_605 = _loc1_.ribbonTypes;
            var_889 = var_1496[0];
            var_202 = var_604[0];
            _ribbonIndex = var_605[0];
            initColorGrid();
            updateColorGrid();
            updatePreview();
         }
