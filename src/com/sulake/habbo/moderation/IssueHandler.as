package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_55.issueManager.releaseBundle(var_105.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_379 = new UserInfoCtrl(_window,var_55,_loc3_.message);
         ...
         if(false)
         {
            var_950.load(_loc4_,var_105.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_55.issueManager.method_6(var_105.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_55.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_55,WindowTracker.const_814,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_55 != null && false && var_105 != null)
         {
            var_55.issueManager.removeHandler(var_105.id);
         }
         this.dispose();
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_55.issueManager.method_6(var_105.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_55.issueManager.method_6(var_105.id,3);
         checkAutoHandling();
         dispose();
      }
