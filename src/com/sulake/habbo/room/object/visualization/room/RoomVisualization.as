package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1384:int = 13421772;
      
      private static const const_757:int = 16777215;
      
      public static const const_1178:int = 10066329;
      
      private static const const_755:int = 13421772;
      
      public static const const_1285:int = 16777215;
      
      private static const const_1411:int = 0;
      
      public static const const_1286:int = 16777215;
      
      private static const const_754:int = 10066329;
      ...
      private var var_558:Rectangle = null;
      
      private var var_1786:int = 255;
      
      private var var_1790:Boolean = false;
      
      private var var_1787:int = 255;
      
      private var var_1784:String = null;
      
      private const const_1632:int = 250;
      ...
      private var var_391:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_391 = new RoomPlaneBitmapMaskParser();
      ...
      private function getLandscapeHeight() : Number
      {
         ...
         while(_loc2_ < var_74.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_245)
            {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_833);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_831);
         var _loc7_:int = 0;
         while(_loc7_ < var_74.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_245)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1233)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_199,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_199 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_558 == null)
         {
            var_558 = super.boundingRectangle;
         }
         return new Rectangle(var_558.x,var_558.y,var_558.width,var_558.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_391.maskCount)
         {
            _loc6_ = var_391.getMaskType(_loc5_);
            _loc7_ = var_391.getMaskLocation(_loc5_);
            _loc8_ = var_391.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_100.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_199 || _loc3_.type == RoomPlane.const_190 && _loc8_ == RoomPlaneBitmapMaskData.const_232)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1439;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1127)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_949 || _loc9_.y != var_1632 || _loc9_.z != var_1629 || param1.scale != var_1630))
            {
               var_949 = _loc9_.x;
               var_1632 = _loc9_.y;
               var_1629 = _loc9_.z;
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_1025);
            if(_loc10_ != var_1784)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_583));
            if(_loc11_ != var_976)
            {
               var_976 = _loc11_;
               var_1787 = var_976 & 255;
               var_1786 = var_976 >> 8 & 255;
               var_1785 = var_976 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1788 + const_1632 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1788 = _loc7_;
         if(var_161 != _loc6_.getUpdateID())
         {
            ...
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_570);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_633);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1789 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_949));
         ...
         while(_loc8_ < var_390.length)
         {
            ...
            _loc17_ = var_390[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_190)
            {
               if(var_1789)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1787 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1786 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1785 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_100.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_199 && param2 != null)
               {
                  _loc5_.id = param2;
               }
