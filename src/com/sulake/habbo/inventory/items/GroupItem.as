package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2277:BitmapData;
      
      protected var var_941:Boolean;
      ...
      protected var var_450:int = 0;
      
      protected var var_1373:String;
      
      private const const_1634:int = 8947848;
      ...
      private const const_1436:Number = 0.2;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_615)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1403));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1373);
         }
         if(_loc1_.id > 0)
         {
