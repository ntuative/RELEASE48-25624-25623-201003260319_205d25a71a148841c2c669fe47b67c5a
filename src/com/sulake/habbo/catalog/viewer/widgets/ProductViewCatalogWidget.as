package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_607 != null)
         {
            var_607.visible = false;
            var_607.destroyGridItems();
         }
         if(var_1292 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1365.text = "${" + _loc3_.name + "}";
            var_1364.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1365.text = "${" + _loc2_.localizationId + "}";
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_412:
                  _loc4_ = var_1291.clone();
                  if(var_607 != null)
                  {
                     var_607.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_607,var_1292,var_1363);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_212:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_292,AvatarAction.const_601);
                              _loc13_.appendAction(AvatarAction.const_537,_loc6_.productClassId);
      ...
      {
         var_1365 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1364 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1544 = new Point(var_84.x,var_84.y);
         var_607 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1292 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_607 == null)
         {
         ...
         var_1291 = _loc2_.content as BitmapData;
