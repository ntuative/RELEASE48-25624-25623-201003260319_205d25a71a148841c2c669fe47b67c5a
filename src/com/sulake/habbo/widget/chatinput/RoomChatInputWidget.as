package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private var var_829:Timer = null;
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         ...
         {
            var_689 = var_689 - 1;
            _visualization.showFloodBlocking(var_689);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_226,onRoomObjectDeselected);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_270,onRoomViewUpdate);
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_704,onChatInputUpdate);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_213,onUserInfo);
         param1.addEventListener(RoomWidgetChatInputDisplayEvent.const_734,onSettings);
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         {
            case RoomWidgetChatInputContentUpdateEvent.const_865:
               _loc2_ = localizations.getKey("widgets.chatinput.mode.whisper",":tell");
               _visualization.displaySpecialChatMessage(_loc2_,param1.userName);
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1207:
         }
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_226,onRoomObjectDeselected);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_270,onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_704,onChatInputUpdate);
         param1.removeEventListener(RoomWidgetChatInputDisplayEvent.const_734,onSettings);
      ...
      private function checkForFlooding() : Boolean
      {
         ...
         {
            if(_loc1_ < var_1217 + const_1084)
            {
               var_830 = true;
               var_689 = const_1083 / 1000;
               Logger.log("Enabling flood blocking");
               var_829 = new Timer(1000,var_689);
               var_829.addEventListener(TimerEvent.TIMER,onReleaseTimerTick);
               var_829.addEventListener(TimerEvent.TIMER_COMPLETE,onReleaseTimerComplete);
               var_829.start();
               if(_visualization != null)
               {
                  _visualization.showFloodBlocking(var_689);
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_732,_visualization.window);
         if(messageListener != null)
         {
