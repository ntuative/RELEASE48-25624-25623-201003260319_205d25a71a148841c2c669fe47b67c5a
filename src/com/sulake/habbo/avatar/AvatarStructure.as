package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_2218:PartOffsetData;
      
      private var var_918:AvatarActionManager;
      
      private var var_177:IAssetLibrary;
      
      private var var_1081:IAssetLibrary;
      
      private var var_1384:Boolean = false;
      
      private var var_2217:AvatarRenderManager;
      ...
      private var var_1579:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_441 = new PartSetsData();
         _animationData = new AnimationData();
         var_1579 = new AvatarStructureDownloadSet();
         var_749 = new AnimationManager();
         var_748 = param4;
         var_2218 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_918.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_918.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return var_918.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_441.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_441.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1308[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_918.getDefaultActionType();
         var _loc9_:Array = var_441.getActiveParts(param3.definition);
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_441.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_441.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      private function onStructureReady(param1:Event = null) : void
      {
         ...
         {
            var_441.getPartDefinition("ri").appendToFigure = true;
            var_441.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_748)
         {
            case AvatarType.const_78:
               ...
               var_1579.add(new AvatarStructureDownload(var_177,_loc5_,var_440));
               break;
            case AvatarType.PET:
         }
         var_1579.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      ...
      {
         var_918 = new AvatarActionManager(var_177,var_748);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_1081.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_1081.getAssetByName("dance" + _loc1_).content as XML;
            var_749.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_1081.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_1081.getAssetByName("fx" + _loc1_).content as XML;
            var_749.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_2218.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      {
         return var_918.sortActions(param1);
      }
   }
}
