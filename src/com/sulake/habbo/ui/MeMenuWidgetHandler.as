   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_196 + " " + _loc6_);
            if(var_196 != null && _loc6_ != null)
            {
               ...
               var_196.events.dispatchEvent(_loc8_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_575,onFigureUpdate);
            }
            if(false)
            {
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_575,onFigureUpdate);
         ...
         if(var_10 != null)
         {
            (var_10 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_987,onAvatarEffectsChanged);
            (var_10 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_962,onHabboClubSubscriptionChanged);
         }
         var_196 = _container.toolbar;
         if(var_196)
         {
            var_196.events.addEventListener(HabboToolbarEvent.const_84,onHabboToolbarEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_403:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_436));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_529);
         _loc1_.push(RoomWidgetDanceMessage.const_688);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_504);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_715);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_737);
         _loc1_.push(RoomWidgetStopEffectMessage.const_652);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1303);
         ...
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_569);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1314);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_945);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_738);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_657);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_556);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1311);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_645);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_606);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_510);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_695));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_657:
               ...
               break;
            case RoomWidgetWaveMessage.const_529:
               if(_container != null && false)
               {
            ...
            case RoomWidgetDanceMessage.const_688:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_504:
               if(var_10 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_737:
               ...
               break;
            case RoomWidgetOpenInventoryMessage.const_715:
               ...
               if(var_10 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_867:
                        _catalog.openCatalogPage(CatalogPageName.const_1315,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_887:
                        var_10.toggleInventoryPage(InventoryCategory.const_235);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1344:
                        var_10.toggleInventoryPage(InventoryCategory.const_71);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1336:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_652:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_810:
            ...
            case RoomWidgetNavigateToRoomMessage.const_963:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_738:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_637:
               ...
               if(var_196)
               {
                  var_196.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_10 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_731:
               ...
               if(var_196 && false)
               {
                  var_196.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_362,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_569:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_519));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_556:
            ...
            case RoomWidgetStoreSettingsMessage.const_645:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_300,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_606:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_300,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_510:
               if(false && _container.habboHelp.events)
               {
