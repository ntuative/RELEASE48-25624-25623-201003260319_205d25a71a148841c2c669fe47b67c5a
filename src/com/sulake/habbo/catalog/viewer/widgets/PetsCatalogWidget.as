package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_403 >= var_299.length)
         {
            return "";
         }
         var petColor:IPetColor = var_299[var_403] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_577[var_1454] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_403 < 0 || var_403 > var_299.length)
         {
            var_403 = 0;
         }
         updateImage();
      ...
      override public function init() : void
      {
         ...
         var_812 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_299 = [];
         var_577 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_812);
               if(_loc11_)
               {
                  var_577 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_577.length)
         {
            _loc12_ = var_577[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_812,_loc12_.id),getRaceLocalizationKey(var_812,_loc12_.id)));
            _loc6_++;
         }
         var_569.add(var_812,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_954,onApproveNameResult);
      ...
      private function updateImage() : void
      {
         ...
         if(var_403 >= 0 && var_403 < var_299.length)
         {
            _loc7_ = var_299[var_403] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_577[var_1454] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_812,_loc3_.id,_loc2_,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_292,AvatarAction.const_516);
