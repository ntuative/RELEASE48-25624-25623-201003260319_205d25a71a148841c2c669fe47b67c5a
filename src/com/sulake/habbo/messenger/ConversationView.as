package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_762:int = 100;
       
      
      private var var_1856:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_128 = param1;
         var_1459 = initButton("follow_friend",onFollowButtonClick,param2);
         var_48 = IItemListWindow(param2.findChildByName("msg_list"));
         var_1856 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_666 || param3.type == Message.const_613 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_478.messages.length - const_762);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_478.messages.length)
         {
            refreshEntry(true,_loc1_,var_478.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_478 == null || _loc1_.id != var_478.id)
         {
            var_478 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_762 + const_1074)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_128.send(new FollowFriendMessageComposer(var_478.id));
      }
