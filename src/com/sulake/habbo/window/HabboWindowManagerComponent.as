package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_698:ISkinContainer;
      ...
      private var var_1246:IEventDispatcher;
      
      private var var_2373:uint = 0;
      
      private var var_1249:ProfilerAgentTask;
      
      private var var_1248:ProfilerOutput;
      
      private var var_699:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1246 = Component(param1).events;
         var_418 = new Array();
      ...
      {
         return var_229[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_229[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_698 = new SkinContainer(_loc3_.content as XML,assets);
         var_699 = new WindowRenderer(var_698);
         var_229 = new Array(const_345);
         var _loc5_:int = 0;
         while(_loc5_ < const_345)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_699,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_229[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_229[const_1105];
         ...
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1301,_loc6_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_229[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_229.pop()).dispose();
            }
            var_229 = null;
            while(false)
            {
      ...
      {
         return var_229[param1].getDesktopWindow().getChildAt(_windowContext.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1248 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1248 = new ProfilerOutput(_loc3_,this,var_699);
               var_1247 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1247);
               var_1249 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1249);
               var_1025 = true;
            }
         }
      }
      ...
      {
         return var_698.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1246.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_345 - 1;
            while(_loc2_ >= 0)
            {
               var_229[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_1025)
         ...
         var_1246.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_345)
         {
            var_229[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1025)
         {
         ...
         var_1246.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1296,new Date().getTime().toString());
