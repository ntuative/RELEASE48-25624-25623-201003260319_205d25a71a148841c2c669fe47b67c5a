package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_867 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_868 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModBanMessageComposer(var_1268,var_419.text,getBanLength(),var_1269));
         this.dispose();
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1268,var_419.text,var_1269));
         this.dispose();
      }
      ...
      {
         return WindowTracker.const_1356;
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_706 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1268,var_419.text,var_1269));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         {
            var_51.findChildByName("offence_txt").caption = this.var_707.name;
            var_51.findChildByName("offence_category").visible = true;
         }
         else if(this.var_706 != null)
         {
            this.refreshButtons("offences_cont",2,var_706.offences,var_867,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_868,onOffenceCtgButton);
      ...
      public function show() : void
      {
         ...
         var_51.caption = "Mod action on: " + var_1516;
