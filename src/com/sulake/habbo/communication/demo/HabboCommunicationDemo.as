package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1769:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1435:ILogger;
      
      private var var_1158:String;
      
      private var var_1768:String;
      
      private const const_1410:String = "fuselogin";
      
      private var var_290:ICoreCommunicationManager;
      
      private var var_389:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1321:
            case DisconnectReasonEvent.const_1322:
            ...
            case DisconnectReasonEvent.const_1237:
               ...
               break;
            case DisconnectReasonEvent.const_1265:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1770)
         {
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1158,var_1768));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1410,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_389.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_389.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1769);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1410,"/");
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1768 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_166 == null)
         {
         ...
         if(var_661 != null)
         {
            var_63.mode = HabboConnectionType.const_359;
            var_63.initConnection(HabboConnectionType.const_250);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1435 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_609);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1769 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_63.mode)
         {
            case HabboConnectionType.const_359:
               _loc6_ = "";
               ...
               var_971 = _loc4_;
               var_166.loadBannerImage(_loc7_ + "?token=" + var_971,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_844:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1400:
               var_556 = generateRandomHexString(30);
               var_389 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_389.init(var_556);
               _loc8_ = var_389.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_971);
         ...
         var_389 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_389.init(_loc14_);
            _loc15_ = var_389.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_63.mode = HabboConnectionType.const_844;
            }
         }
         var_63.initConnection(HabboConnectionType.const_250);
      }
