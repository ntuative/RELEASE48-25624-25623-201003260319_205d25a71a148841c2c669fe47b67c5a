package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_512:Number = 64;
      
      public static const const_972:Number = 32;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            var_80.assign(_loc23_);
            _y.assign(_loc24_);
            var_81.assign(_loc25_);
         }
         else
         {
            var_80.assign(_loc18_);
            _y.assign(_loc19_);
      ...
      {
         if(var_412 != param1 * var_1482)
         {
            var_412 = param1 * var_1482;
            ++var_75;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_411 != null)
         {
            ...
            var_411.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_411.add(_loc3_,_loc4_);
            ++var_75;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_998.assign(_loc22_);
         }
         else
         {
            var_998.assign(_loc17_);
         }
         ++var_75;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_412;
         _loc2_.z *= var_410;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_998);
         if(_loc3_ < var_2344 || _loc3_ > var_2343)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,var_80);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_412;
            _loc2_.z *= var_410;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_998);
         }
      ...
      {
         return new Vector3d(0 * var_409,0 * var_412,0 * var_410);
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc2_:Number = Vector3d.scalarProjection(param1,var_80);
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_411 != null)
         {
            ...
            return var_411.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_80,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_409,0 * var_412,0 * var_410);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_81;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_409,param2.y * var_412,param2.z * var_410);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_409,param3.y * var_412,param3.z * var_410);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_409,param4.y * var_412,param4.z * var_410);
