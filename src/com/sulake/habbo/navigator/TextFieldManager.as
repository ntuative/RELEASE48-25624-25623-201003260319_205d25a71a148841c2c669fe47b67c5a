package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         var_71.addEventListener(WindowEvent.const_133,checkMaxLen);
         this.var_2329 = var_71.textBackground;
         this._orgTextBackgroundColor = var_71.textBackgroundColor;
         this.var_2331 = var_71.textColor;
      }
      ...
      {
         var_71.textBackground = this.var_2329;
         var_71.textBackgroundColor = this._orgTextBackgroundColor;
         var_71.textColor = this.var_2331;
      }
      ...
      private function checkMaxLen(param1:Event) : void
      {
         ...
         if(_loc2_.length > var_1592)
         {
            var_71.text = _loc2_.substring(0,var_1592);
         }
      }
   }
}
