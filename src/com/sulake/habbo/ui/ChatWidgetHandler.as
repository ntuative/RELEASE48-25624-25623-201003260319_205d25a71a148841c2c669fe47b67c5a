package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_506:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_507 != null)
         {
            ...
            {
               _loc2_ = var_507.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_507.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_704.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_507.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_704.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_694,RoomWidgetChatSelectAvatarMessage.const_509];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_694:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_136,_container.roomSession,0,"Version 25624-25623-201003260245");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_509:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_865 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_865);
            }
            if(var_506 == null)
            {
               var_505.x = 0;
               var_505.y = 0;
               var_505.z = 0;
               var_506 = _loc4_.getScreenPoint(var_505);
               var_865 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_505.x = 0;
            ...
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_506.x || _loc8_.y != var_506.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_506,_loc5_));
