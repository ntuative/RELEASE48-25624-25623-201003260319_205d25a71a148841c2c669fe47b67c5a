package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1141:String = "normal_badge";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         switch(param2)
         {
            case const_1141:
               if(var_145 != null)
               {
                  _loc5_ = var_145.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_878:
               if(var_145 != null)
               {
                  if(var_145 != null)
                  {
                     _loc5_ = var_145.getKey("group.badge.url");
