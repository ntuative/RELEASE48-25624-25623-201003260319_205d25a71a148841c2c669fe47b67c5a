package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_543,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1023,onHideWindowEvent);
         var_31 = true;
