package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1308:Map = new Map();
      
      private static var var_900:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         var _loc1_:String = "";
         var _loc2_:int = 0;
         while(_loc2_ < var_900.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_900.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_900.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         return var_1308[param1];
      }
      
      public static function addDebugData(param1:String, param2:String) : void
      {
         var_900.remove(param1);
         var_900.add(param1,param2);
      }
