package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_501:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_336.shockwaveClientUrl = var_106.shockwaveClientUrl;
         var_336.ssoTicket = var_106.ticket;
         var_106.removeEventListener(SSOTicket.const_326,onParsedTicketSuccess);
         var_106.removeEventListener(SSOTicket.const_259,onParsedTicketFailure);
         var_106 = null;
         dispatchEvent(new Event(const_501));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1410,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_336.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_434,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1410,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_106 = new SSOTicket(var_336.assets,_loc2_,_loc1_);
         var_106.addEventListener(SSOTicket.const_326,onParsedTicketSuccess);
         var_106.addEventListener(SSOTicket.const_259,onParsedTicketFailure);
      }
