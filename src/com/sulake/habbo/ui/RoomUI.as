package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_844:IRoomWidgetFactory;
      ...
      private var var_553:IAvatarRenderManager;
      ...
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         queueInterface(new IIDHabboCatalog(),method_9);
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_509 = param2 as IHabboSoundManager;
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_99:
               if(param1.session != null)
               {
                  ...
                  var_196.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_154,HabboToolbarIconEnum.ZOOM));
                  var_196.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_154,HabboToolbarIconEnum.MEMENU));
                  var_196.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_154,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            var_272.events.addEventListener(AdEvent.const_416,adEventHandler);
            var_272.events.addEventListener(AdEvent.const_374,adEventHandler);
            var_272.events.addEventListener(AdEvent.const_392,adEventHandler);
         }
      }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_844 = param2 as IRoomWidgetFactory;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_844 != null)
         {
            var_844.release(new IIDHabboRoomWidget());
            var_844 = null;
         }
         if(var_10 != null)
         {
         ...
         if(var_196 != null)
         {
            var_196.release(new IIDHabboToolbar());
            var_196 = null;
         }
         if(_config != null)
         {
         ...
         if(var_509 != null)
         {
            var_509.release(new IIDHabboSoundManager());
            var_509 = null;
         }
         if(var_272 != null)
         {
         ...
         if(var_553 != null)
         {
            var_553.release(new IIDAvatarRenderManager());
            var_553 = null;
         }
         if(_catalog != null)
         {
         ...
         if(var_718 != null)
         {
            var_718.release(new IIDHabboModeration());
            var_718 = null;
         }
         if(_navigator != null)
         {
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_589)
            {
               var_1538 = _loc3_;
            }
            _loc2_.dispose();
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_718 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + var_718);
      }
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_629:
               ...
               if(_roomEngine != null)
               {
                  ...
                  if(!_roomEngine.isPublicRoomWorldType(_roomEngine.getWorldType(param1.roomId,param1.roomCategory)))
                  {
                     ...
                     _loc7_.iconState = "2";
                     var_196.events.dispatchEvent(_loc7_);
                  }
                  else
                  {
                     _loc5_ = true;
               ...
               if(var_1538 != RoomDesktop.const_589)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_239,var_1538);
               }
               if(var_272 != null)
               {
                  var_272.showRoomAd();
            ...
            case RoomEngineEvent.const_563:
               ...
               break;
            case RoomEngineRoomColorEvent.const_578:
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_211:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_502:
               errorMessage = "${room.error.pets.forbidden_in_hotel}";
               break;
            case RoomSessionErrorMessageEvent.const_655:
               errorMessage = "${room.error.pets.forbidden_in_flat}";
               break;
            case RoomSessionErrorMessageEvent.const_518:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomEngineEvent.const_623,roomEngineEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_629,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_563,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_58,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_578,roomEventHandler);
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_553 = param2 as IAvatarRenderManager;
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_196 = param2 as IHabboToolbar;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(var_18)
         {
            var_18.events.addEventListener(RoomSessionEvent.const_298,roomSessionStateEventHandler);
            var_18.events.addEventListener(RoomSessionEvent.const_91,roomSessionStateEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionDoorbellEvent.const_130,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_560,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_809,roomSessionDialogEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_502,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_655,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_161,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_518,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_703,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionQueueEvent.const_363,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionDimmerPresetsEvent.const_397,roomSessionEventHandler);
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1277 = param2 as IHabboAvatarEditor;
      }
   }
}
