package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_805:MarketPlaceOfferData;
      
      private const const_1414:int = 1;
      
      private const const_1636:int = 40;
      ...
      private function updateList() : void
      {
         ...
         if(!var_399)
         {
            var_399 = new Timer(25);
            var_399.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_804 = 0;
         populateList();
         var_399.start();
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1414);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_398.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_399)
         {
            var_399.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_399 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_804 >= var_569.length)
            {
               return true;
            }
            addListItem(var_569.getWithIndex(var_804));
            ++var_804;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_805.offerId);
            }
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_398));
            _loc7_.selection = 0;
         }
      }
