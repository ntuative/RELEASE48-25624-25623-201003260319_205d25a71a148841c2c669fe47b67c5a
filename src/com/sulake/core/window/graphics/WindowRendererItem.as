package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_388:
               ...
               break;
            case WindowRedrawFlag.const_825:
               var_732 = var_698.getTheActualState(param1.type,param1.style,param1.state);
               if(var_732 != var_1059)
               {
                  var_238 = true;
                  _loc4_ = true;
            ...
            case WindowRedrawFlag.const_835:
               ...
               break;
            case WindowRedrawFlag.const_277:
               _loc4_ = true;
         }
         if(_loc4_)
         {
      ...
      {
         return var_698.getTheActualState(param1.type,param1.style,param1.state) != var_1059;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc11_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_787) : uint(const_497);
         var _loc7_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(var_732))
            {
               _loc5_ = const_786;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_786)
               {
                  ...
                  if(var_238)
                  {
                     ...
                     _loc7_.draw(param1,var_91,var_91.rect,var_732,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_32))
                  {
                     ...
                     _loc4_.draw(var_91,var_933,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = var_698.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_839)
            {
               _loc2_ = var_698.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_839);
            }
         }
         return _loc2_;
      }
