package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_350:String = "place_holder";
      
      private static const const_1120:String = const_350;
      ...
      public static const const_659:String = "RCL_LOADER_READY";
      ...
      private var var_1055:IEventDispatcher = null;
      
      private var var_1306:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_522 = [];
         var_521 = [];
         var_2112 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2111 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_429 = new Map();
         _events = new Map();
      ...
      {
         return [const_350,const_494,ROOM_CONTENT,const_783,const_784];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2112.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_156 && _loc5_ != RoomObjectLogicEnum.const_122)
         {
            _loc6_ = "@shadow";
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_610.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1275);
               return;
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(var_2113)
         {
            ...
            if(var_1055 != null)
            {
               var_1055.dispatchEvent(new Event(const_659));
            }
         }
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1055 = param1;
            var_2114 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2109 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2110 = param2.getKey("public.room.dynamic.download.url","");
            var_2115 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_31 = const_782;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_156 && _loc5_ != RoomObjectVisualizationEnum.const_122)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_414.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1306.getValue(param1) != null)
         {
            var_173 = var_1306.getValue(param1) as PublicRoomData;
         }
