package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_791:String = "margin_top";
      
      private static const const_1131:String = "_HEADER";
      
      private static const const_789:String = "margin_right";
      
      private static const const_1130:String = "_SCALER";
      
      private static const const_1114:String = "_TITLE";
      
      private static const const_1129:String = "_CONTENT";
      
      private static const const_788:String = "margin_left";
      
      private static const const_790:String = "margin_bottom";
      ...
      private var var_1312:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_788,_loc3_.left,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_791,_loc3_.top,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_789,0 - _loc3_.right,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_790,0 - _loc3_.bottom,PropertyStruct.const_61,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1312 == null)
         {
            var_1312 = findChildByTag(const_1131) as IHeaderWindow;
            if(!var_1312)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1114) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1130) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1384 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_19 == null)
         {
            var_19 = findChildByTag(const_1129) as IWindowContainer;
            if(!var_19)
            {
