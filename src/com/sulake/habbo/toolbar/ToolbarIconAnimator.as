package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_1143 = param1.loop;
         if(param1.background != null)
         {
            var_783 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_782.push(new XML());
               var_784.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_784[var_51] = param6.clone();
         }
      ...
      {
         if(var_1143 == true || var_654 == 0)
         {
            if(false)
            {
               ++var_51;
               if(var_51 >= var_782.length)
               {
                  var_51 = 0;
                  ++var_654;
               }
      ...
      {
         return var_1143 == false && var_654 == 1 && var_1252 != var_31;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_783 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_783.width),Math.max(param2.height,var_783.height));
            _loc3_.copyPixels(var_783,var_783.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_51 <= var_784.length)
         {
            _loc2_ = var_784[var_51];
