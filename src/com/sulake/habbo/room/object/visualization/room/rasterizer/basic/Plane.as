package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_674:PlaneVisualization = null;
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = var_297.getWithIndex(_loc1_) as PlaneVisualization;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_674 = var_297.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_674 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_297 != null)
         {
            ...
            {
               _loc1_ = var_297.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
