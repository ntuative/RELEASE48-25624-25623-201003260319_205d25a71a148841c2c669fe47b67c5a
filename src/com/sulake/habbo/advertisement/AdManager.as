package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_774:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_392,0,0,_loc4_,var_1405,var_774,var_775));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         ...
         var_1666 = int(_config.getKey("interstitial.show.time","5000"));
         var_1406 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1135 = _loc2_.method_5;
         var_1405 = _loc2_.clickUrl;
         if(var_1135 != "" && var_1405 != "")
         {
            _loc3_ = var_1135;
            ...
            _loc4_ = new URLRequest(var_1135);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1136 = _loc2_.method_5;
         var_1668 = _loc2_.clickUrl;
         var_646 = getTimer();
         if(var_1136 != "")
         {
            _loc3_ = var_1136;
            ...
            var_215.start();
            _loc4_ = new URLRequest(var_1136);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_374,0,0,param1.bitmapData,var_1668));
            var_646 = getTimer();
         }
         else
         {
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1406 > 0 && var_1404 >= var_1406)
         {
            return false;
         }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_774 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
