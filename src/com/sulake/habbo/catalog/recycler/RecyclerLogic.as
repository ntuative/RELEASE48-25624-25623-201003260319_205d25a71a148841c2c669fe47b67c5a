package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_778:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1517)
         {
            case RecyclerStatusMessageEvent.const_1352:
               ...
               break;
            case RecyclerStatusMessageEvent.const_1000:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1362:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1517 != RecyclerStatusMessageEvent.const_1000;
      }
      
      private function get statusActive() : Boolean
      {
         return var_268 != const_778;
      }
      ...
      {
         return active && var_268 == const_347;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_852:
               if(_view != null)
               {
