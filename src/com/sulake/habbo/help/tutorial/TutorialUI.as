package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         _main = param1;
         _main.events.addEventListener(HabboHelpTutorialEvent.const_554,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_519,onTaskDoneEvent);
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         var_1015 = param2;
         var_1016 = param3;
         if(var_36 == null || var_36.id == const_83)
         {
            prepareForTutorial();
            showView(const_83);
         }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         var_1015 = true;
         if(var_36 != null && (var_36.id == const_240 || var_36.id == const_83))
         {
            showView(const_83);
         }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1566;
         _window.width = _loc2_.width + var_1567;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_554:
               var_1016 = true;
               if(var_36 != null && var_36.id == const_450)
               {
                  showView(const_83);
               }
               break;
            case HabboHelpTutorialEvent.const_519:
               if(var_36 != null && var_36.id == const_337)
               {
                  var_1240 = true;
                  disposeWindow();
               }
      ...
      {
         var_1014 = true;
         if(var_36 != null && (var_36.id == const_337 || var_36.id == const_83))
         {
            showView(const_83);
         }
      }
      ...
      {
         return var_1014 && var_1015 && var_1016;
      }
   }
}
