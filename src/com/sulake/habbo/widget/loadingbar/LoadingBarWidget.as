package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_375:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_375 = new Sprite();
            var_375.addChild(new Bitmap(_image));
            var_375.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_375.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_375);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1389 != "")
         {
            HabboWebTools.openWebPage(var_1389);
         }
      }
      ...
      override public function dispose() : void
      {
         if(var_375 != null)
         {
            var_375.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_375 = null;
         }
         if(_image != null)
         {
