package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1140:uint = 9;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         else if(param1 is TradingAcceptEvent)
         {
            ...
            if(TradingAcceptEvent(param1).userID == var_682)
            {
               var_480 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_681 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_45.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_682)
            {
               var_45.alertPopup(TradingView.const_838);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_31 + " NEW STATE: " + param1 + " OWN: " + var_480 + " OTHER: " + var_681);
         ...
         {
            case const_166:
               if(param1 == const_167 || param1 == const_229)
               {
                  var_31 = param1;
                  _loc2_ = true;
               }
      ...
      public function close() : void
      {
         if(var_618)
         {
            if(var_31 != const_166 && var_31 != const_229)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_166;
            var_10.toggleInventorySubPage(InventorySubCategory.const_939);
            var_618 = false;
         }
         var_45.setMinimized(false);
      }
