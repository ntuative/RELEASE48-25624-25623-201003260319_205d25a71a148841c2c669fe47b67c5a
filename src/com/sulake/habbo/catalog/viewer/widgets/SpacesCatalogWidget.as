package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1368:String = "default";
      
      private var var_1338:Array;
      
      private var var_281:BitmapData = null;
      
      private var var_239:int = 0;
      
      private var var_742:int = 0;
      
      private var var_1366:String = "1.1";
      ...
      override public function init() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               {
                  case "floor":
                     for each(_loc9_ in var_145.floors.pattern)
                     {
                     ...
                     break;
                  case "wallpaper":
                     for each(_loc10_ in var_145.walls.pattern)
                     {
                     ...
                     break;
                  case "landscape":
                     for each(_loc11_ in var_145.landscapes.pattern)
                     {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_281 != null && var_282 != null)
         {
            setRoomImage(var_281,var_282);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_145.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_239 >= 0)
         ...
         for each(_loc1_ in var_145.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[var_283];
               if(_loc11_ != null)
               {
         ...
         for each(_loc1_ in var_145.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_189:
               ...
               var_741 = 0;
               _loc5_ = "null";
               for each(_loc8_ in var_145.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
            ...
            case const_191:
               ...
               for each(_loc9_ in var_145.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_743 = _loc9_.children().length();
                  }
               }
            ...
            case const_190:
               ...
               var_742 = 0;
               _loc7_ = "null";
               for each(_loc10_ in var_145.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_742 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1368);
               }
               break;
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1368,var_1366,64,this,"window_romantic_wide");
