package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1213:AssetAliasCollection;
      
      private var var_995:PaletteManager;
      
      private var var_686:PetDataManager;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_78:
               _loc3_ = var_226.getValue(AvatarType.const_78) as AvatarStructure;
               break;
            case AvatarType.PET:
               _loc3_ = var_226.getValue(AvatarType.PET) as AvatarStructure;
               break;
            default:
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_226.getValue(AvatarType.const_78) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
         _loc2_ = var_226.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
      ...
      private function init() : void
      {
         ...
         var_1213 = new AssetAliasCollection(_loc1_,_loc3_);
         var_686 = new PetDataManager(_loc1_,_loc3_);
         var_995 = new PaletteManager(_loc1_,_loc3_);
         var _loc4_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_686.populateFigureData(_loc4_);
         ...
         var_226.add(AvatarType.const_78,_loc5_);
         _loc5_ = new AvatarStructure(this,assets,_loc1_,AvatarType.PET);
         _loc5_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_226.add(AvatarType.PET,_loc5_);
         initHardCodedAliases();
      }
      
      public function get petDataManager() : IPetDataManager
      {
         return var_686 as IPetDataManager;
      }
      
      public function set mode(param1:String) : void
      {
         var_635 = param1;
         if(var_635 == RenderMode.const_1219)
         {
            init();
         }
         if(var_635 == RenderMode.const_1183)
         {
            init();
      ...
      {
         return var_1213.getAssetByName(param1);
      }
      ...
      {
         var _loc5_:String = var_686.createAvatarFigureStringNew(param1,param2,param3);
         var _loc6_:AvatarStructure = var_226.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc6_,var_1213,_loc5_,param4,AvatarType.PET);
      }
      ...
      {
         var _loc2_:AvatarStructure = var_226.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = var_226.getValue(AvatarType.const_78) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_1213,param1,param2,AvatarType.const_78);
      }
