package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1448,var_1447);
         }
      }
      ...
      {
         if(param1 != var_1820 || param2 != var_1817)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1823);
      }
      ...
      {
         if(var_47 != null && false && var_220 != null)
         {
            var_47.furniModel.removeLockFrom(var_220.id);
            var_220 = null;
         }
      }
