package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2238:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1588,this._model.mode != ThumbnailEditorModel.const_53);
         setEnabled(var_1589,this._model.mode != ThumbnailEditorModel.const_34);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1588 = IButtonWindow(find("top_tab"));
         var_1589 = IButtonWindow(find("obj_tab"));
         var_2237 = IWindowContainer(find("tile_grid"));
         var_2238 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1588,onTopTabButton);
         Util.setProcDirectly(var_1589,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2237;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_371)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_2238;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_56,HabboWindowStyle.const_40,HabboWindowParam.const_69,new Rectangle(0,0,param1.width,66)));
